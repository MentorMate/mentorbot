...
#pragma warning disable CS4014
        ...
        public async Task WhenAskedNotifyForTimesheets()
        {
            ...
            _mailService.Received()
                .SendMailAsync("Users not notified", Arg.Is<string>(s => s.Contains("All users with unsubmitted timesheets are notified! Total of 2.</b>Jhon</b><br/><b>ElA<br/><b>")), "a@b.c");
        }
